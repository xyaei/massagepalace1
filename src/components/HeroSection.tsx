    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 py-12 md:py-16 max-w-4xl mx-auto">
        <motion.h1
          ...
          className="font-display text-5xl md:text-7xl lg:text-8xl font-bold mb-6 text-gradient-gold leading-[1.08]"
        >
          Massage Palace
        </motion.h1>
        ...
        <motion.p
          ...
          className="font-accent text-lg md:text-xl text-foreground/80 mb-10 max-w-3xl mx-auto italic leading-[1.15]"
        >
